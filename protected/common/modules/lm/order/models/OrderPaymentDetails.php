...
class OrderPaymentDetails extends \usni\library\db\TranslatableActiveRecord 
{
    ...
    public function scenarios()
    {
        ...
        $scenarios['create'] = $scenarios['update'] = ['order_id', 'payment_method', 'gateway', 'total_including_tax', 'tax', 'payment_type', 'comments', 'shipping_fee'];
        return $scenarios;
    }
	...
	public function attributeLabels()
	{
		$labels = [
                     ...
                     'gateway'   => UsniAdaptor::t('payment', 'Gateway Method'),
