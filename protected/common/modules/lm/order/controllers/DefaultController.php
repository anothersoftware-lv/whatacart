...
{   
    ...
    public function beforeAction($action)
    {
        if(parent::beforeAction($action))
        {
            ...
            $this->checkoutManager = AdminCheckoutManager::getInstance(['paymentFactoryClassName' => AdminPaymentFactory::class]);
            return true;
        }
        return false;
    }
    ...
    public function actions()
    {
        return [
            'index'  => ['class' => IndexAction::class,
                         ...
                         'dtoClass' => GridViewDTO::class,
                         'viewFile' => '/index'
                        ],
            'view'   => ['class' => ViewAction::class,
                         'modelClass' => Order::class,
                         'detailViewDTOClass' => DetailViewDTO::class,
                         'viewFile' => '/view'
                        ],
            ...
            'bulk-edit' => ['class' => BulkEditAction::class,
                            'modelClass' => Order::class
                        ],
            'bulk-delete' => ['class' => BulkDeleteAction::class,
                              'modelClass' => Order::class
                        ],
        ];
    }
