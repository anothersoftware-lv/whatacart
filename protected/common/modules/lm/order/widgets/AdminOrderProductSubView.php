...
class AdminOrderProductSubView extends \yii\bootstrap\Widget
{
    ...
    public function behaviors()
    {
        ...
        return ArrayUtil::merge($behaviors, [AdminOrderProductSubViewBehavior::class]);
    }
    ...
    protected function getFullViewParams()
    {
        ...
        if(isset($paymentDetails->transaction_fee)) {
            $this->totalPrice += $paymentDetails->transaction_fee;
        }
