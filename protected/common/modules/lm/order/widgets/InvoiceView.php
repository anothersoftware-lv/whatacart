...
class InvoiceView extends \yii\bootstrap\Widget
{
    ...
    public function run()
    {
        ...
        $invoiceType = isset($this->invoice['type']) ? $this->invoice['type'] : 1;
            $title          = (1 == $invoiceType ? 'Pavadzīme-rēķins Nr. ' : 'Avansa rēķins Nr. ') . $this->invoiceDisplayedId; //UsniAdaptor::t('order', 'Invoice ' . $this->invoiceDisplayedId);
    ...
    protected function getInvoiceSummary()
    {
        ...
        $paymentValidUntil  = 'cashondelivery' == $this->invoice['payment_method'] ? 'Apmaksa preces saņešanas brīdī' : 'Priekšapmaksa';
    ...
    protected function getCompanyAddress()
    {
        ...
        $companyData = StoreUtil::getCompanyConfig();
