...
$detailViewModel = $detailViewDTO->getModel();

$this->title = UsniAdaptor::t('order', 'View Invoice') . ' #' . $detailViewModel['unique_id'];
/* @var $detailViewDTO \common\modules\order\dto\InvoiceDetailViewDTO */
/* @var $this \usni\library\web\AdminView */
echo InvoiceView::widget(['invoice' => $detailViewModel, 'orderProducts' => $detailViewDTO->getOrderProducts()]);
