...
use cart\business\CheckoutManagerCustom as CheckoutManager;
use cart\dto\CheckoutDTO;
use cart\dto\ReviewDTO;
use common\modules\payment\components\PaymentFactoryCustom as PaymentFactory;
...
class CheckoutController extends BaseController
{
    ...
    public function beforeAction($action)
    {
        ...
        {
            $this->checkoutManager  = CheckoutManager::getInstance(['paymentFactoryClassName' => PaymentFactory::class]);
            return true;
        }
        return false;
    }
    ...
    public function actionIndex()
    {
        ...
        else
        {
            ...
            $checkoutDTO->setCustomerInfo(ApplicationUtil::getCustomerInfo());
            ...
            return $this->render('/checkout-custom', ['formDTO' => $checkoutDTO]);
        }
    }
