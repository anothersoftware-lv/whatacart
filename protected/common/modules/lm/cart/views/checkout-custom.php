...
<?php /*
    ...
    <div class="shop-section mb-80">
        <div class="container">
            ...
            <hr>
            <?php echo $this->render('/_billingeditform', ['form' => $form, 'model' => $billingAddressModel]);?>
            <hr>
            <?php if($isShippingRequired): ?>
                <?php echo $this->render('/_deliveryoptions-custom', ['form' => $form, 'formDTO' => $formDTO]);?>
                <hr/>
            <?php endif; ?>
            <?= $this->render('/_paymentoptions-custom', ['form' => $form, 'formDTO' => $formDTO]) ?>
            <hr>
            <div class="row">
                <div class="col-md-6">
                    <?=
