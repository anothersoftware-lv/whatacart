                                    ...
                                    if(c) {
                                          $.each(attributes, function(index, value){
                                            if(value == 'city' || value == 'state') {
                                                var el = $('#billinginfoeditform-' + value),
                                                inputValue = el.select2('val'),
                                                targetEl = $('#deliveryinfoeditform-' + value);
                                              
                                                if(value == 'city') {
                                                     $('#billinginfoeditform-city').off('change');
                                                     //var options = $('#billinginfoeditform-city').data('select2').options.options,
                                                     //target.html('');
                                                     //targetEl.select2('destroy').empty().select2({data: [{id: 1, text: 'new text'}]});
                                                     
                                                }
                                                                                        
                                                targetEl.select2('val', inputValue);
                                                $('#billinginfoeditform-city').on('change');
